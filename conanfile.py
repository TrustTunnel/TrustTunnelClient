...
class VpnLibsConan(ConanFile):
    ...
    def requirements(self):
        ...
        self.requires("dns-libs/2.4.39@adguard_team/native_libs_common", transitive_headers=True)
        ...
        self.requires("native_libs_common/4.0.20@adguard_team/native_libs_common", force=True, transitive_headers=True)
